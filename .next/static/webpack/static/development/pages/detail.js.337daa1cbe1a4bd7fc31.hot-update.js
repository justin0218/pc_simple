        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 13:
                setTimeout(function () {
                  document.documentElement.scrollTop = document.getElementById("rbox").clientHeight - document.getElementById("news_pl").clientHeight;
                  window.pageYOffset = document.getElementById("rbox").clientHeight - document.getElementById("news_pl").clientHeight;
                  document.body.scrollTop = document.getElementById("rbox").clientHeight - document.getElementById("news_pl").clientHeight;
                }, 500);
                _context3.next = 20;
                break;
...
//# sourceMappingURL=detail.js.337daa1cbe1a4bd7fc31.hot-update.js.map