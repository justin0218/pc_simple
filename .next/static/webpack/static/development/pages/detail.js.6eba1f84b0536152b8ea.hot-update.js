          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                id = this.props.query.id;
                _context4.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_16___default.a.post("".concat(_utils_config__WEBPACK_IMPORTED_MODULE_14__["apiHost"], "/v1/blog/good/make?blog_id=").concat(id), bytes, {
                  headers: {
                    'Content-Type': 'application/octet-stream'
                  }
                });
...
//# sourceMappingURL=detail.js.6eba1f84b0536152b8ea.hot-update.js.map