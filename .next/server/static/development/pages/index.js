          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return fetch("".concat(_utils_config__WEBPACK_IMPORTED_MODULE_13__["apiHost"], "/v1/blog/list?type=-1"));
...
var apiHost = "//10.163.85.169:8888"; // if(location.domain == "www.momoman.cn"){
